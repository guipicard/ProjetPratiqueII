    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.Alpha1)) // Blue
        {
            ...
            else
            {
                ...
                {
                    LevelManager.instance.ErrorAction?.Invoke($"Collect {unlockPrice} blue crystals to unlock this spell.");
                }
            }
        }
        ...
        if (Input.GetKeyDown(KeyCode.Alpha2)) // Yellow
        {
            ...
            else
            {
                ...
                {
                    LevelManager.instance.ErrorAction?.Invoke($"Collect {unlockPrice} yellow crystals to unlock this spell.");
                }
            }
        }
        ...
        if (Input.GetKeyDown(KeyCode.Alpha3)) // Green
        {
            ...
            else
            {
                ...
                {
                    LevelManager.instance.ErrorAction?.Invoke($"Collect {unlockPrice} green crystals to unlock this spell.");
                }
            }
        }
        ...
        if (Input.GetKeyDown(KeyCode.Alpha4)) // Red
        {
            ...
            else
            {
                ...
                {
                    LevelManager.instance.ErrorAction?.Invoke($"Collect {unlockPrice} red crystals to unlock this spell.");
                }
            }
        }
        ...
        if (m_Aiming)
        {
            ...
            if (Physics.Raycast(m_MouseRay, out m_HitInfo, Mathf.Infinity, groundLayer))
            {
                if (Time.timeScale == 1.0f)
                {
                    Vector3 pos = m_HitInfo.point;
                    pos.y = 1.0f;
                    pos -= m_AimOffset;
